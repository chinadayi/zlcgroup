	...
	<div class="main">
		...
		<div class="bg_center">
			<div class="bg_left">
				<div class="bg_right">
					<div class="content">
					<div class="agre_title">RTCMS(ReTengCMS)软件使用协议</div>
					<div class="agre_content">
					　　感谢您选择RTCMS(ReTengCMS)产品。希望我们的努力能为您提供一个高效、快速和强大的网站解决方案。 <br />
					<br />
					　　本《RTCMS(ReTengCMS)用户使用授权许可协议》(以下简称"RTCMS")是您(自然人、法人或其他组织)与RTCMS之间有关复制、下载、安装、使用RTCMS相关产品以及任何相关材料、补丁更新的法律协议，同时本协议亦适用于任何有关本软件的后期更新和升级。一旦复制、下载、安装或以其他方式使用本软件，即表明您同意接受本协议各项条款的约束。如果您不同意本协议中的条款，请勿复制、下载、安装或以其他方式使用本软件。<br />
					<br /> 
					<strong>RTCMS(ReTengCMS)最终用户授权许可协议：</strong><br />
					　　本《RTCMS(ReTengCMS)用户使用授权许可协议》(以下简称"RTCMS")是您(自然人、法人或其他组织)与RTCMS之间有关复制、下载、安装、使用RTCMS相关产品以及任何相关材料、补丁更新的法律协议，同时本协议亦适用于任何有关本软件的后期更新和升级。一旦复制、下载、安装或以其他方式使用本软件，即表明您同意接受本协议各项条款的约束。如果您不同意本协议中的条款，请勿复制、下载、安装或以其他方式使用本软件。<br />
					<br />
					...
					3、 不管您的网站是否整体使用RTCMS，还是部份栏目使用RTCMS，在您使用了RTCMS的网站主页上必须保留RTCMS版权信息及相关链接。<br />
					...
					5、服务网站数量：一份RTCMS使用授权安装为一个服务网站，同一域名下安装多套RTCMS则视为多个服务网站。<br />
					<br />
					...
					　　RTCMS不对使用本软件构建的网站的任何信息内容以及导致的任何版权纠纷和法律争议及后果承担责任。<br />
					　　有关本软件最终用户授权协议、商业授权与技术服务的详细内容，均由RTCMS(http://cms.reteng.org/)和官网(http://www.reteng.org/)提供唯一的解释和官方价目表。RTCMS拥有在不提前通知的情况下，修改授权协议和价目表的权力，修改后的协议或价目表对自改变之日起的新授权用户生效。<br />
					<br /> 
					<strong>权利和所有权的保留：</strong><br />
					　　RTCMS保留所有未在本协议中明确授予您的权利。<br />
					　　您一旦开始安装本软件，即被视为完全理解并接受本协议的各项条款，在享有上述条款授予的权力的同时，受到相关的约束和限制。协议许可范围以外的行为，将直接违反本授权协议并构成侵权，我们有权随时终止授权，责令停止损害，并保留追究相关责任的权力。<br />
					　　请购买前务必认清并理解不同技术服务方式及服务范围。技术支持只面向官方标准安装版本，自行修改或使用非原始RTCMS程序代码后可能产生的问题均不在服务范围之内。
					</div>
