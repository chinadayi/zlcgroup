...
<div class="container">
  <div class="page-wrap">
    <div class="register-page-box">
      <div class="reg-box fl"> <strong class="regi-title"><?php echo $memlang['mem-register'];?></strong>
        <div class="tb">
      ...
      <div class="reg-login-tip fr">
        <div class="reg-login">
          <p class="fz14"><?php echo $memlang['has-register'];?><br><?php echo $memlang['login-now'];?></p>
