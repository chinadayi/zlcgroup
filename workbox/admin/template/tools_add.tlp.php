...
<div id="wrap">
	<div class="tab">
		<ul>
			...
			<li><a href="?mod=workbox&file=workbox&action=tools&boxid=<?php echo $boxid;?>">选项管理</a></li>
			<li><a href="javascript:void(0);" class="on">添加选项</a></li>
	...
	<input type="hidden" name="info[boxid]" value="<?php echo $boxid;?>" />
	<table cellspacing="0" class="sub">
		...
		<tr>
			...
			<td>
			<input type="text" size="36" value="http://" datatype="url" name="info[url]" />
			</td>
		</tr>
