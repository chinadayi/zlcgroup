...
<div id="wrap">
	<div class="tab">
		<ul>
			<li><a href="?file=model&action=manage"><?php echo $lang['MODEL-LANG-1'];?></a></li>
	...
	<table cellspacing="0" class="sub" width="98%">
		...
		<?php }?>
		<tr class="bg2"><td></td><td><input type="button" class="button" onclick="alert('预览状态不能操作!');" value="保存内容" /> <input type="button" class="button" onclick="window.location.href='<?php echo ADMIN_FILE;?>?file=model&action=manage'" value="取消返回" /></td></tr>
	</table>
	</form>
	</div>
</div>
