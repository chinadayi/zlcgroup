...
<div id="wrap">
	<div class="tab">
		<ul>
			...
			<li><a href="?file=model&action=fields_add&modelid=<?php echo $modelid;?>"><?php echo $lang['LEFT-MODULE-14'];?></a></li>
			<li><a href="javascript:void(0);" class="on"><?php echo $lang['LEFT-MODULE-15'];?></a></li>		
		</ul>
	</div>
	<div class="main">
	<fieldset>
		...
		<tr>
			...
			<ul>
				...
				<li><input type="radio" <?php echo in_array($r['form'],array('title','style','thumb','keywords','description','posid','content','status','point','amount'))?' disabled="disabled"':'';?> class="radio" name="info[form]" <?php echo $r['form']=='author'?' checked="checked"':'';?> value="author" />文章作者(author)</li>
			  	<li><input type="radio" <?php echo in_array($r['form'],array('title','style','thumb','keywords','description','posid','content','status','point','amount'))?' disabled="disabled"':'';?> class="radio" name="info[form]" <?php echo $r['form']=='baidueditor'?' checked="checked"':'';?> value="baidueditor" />编 辑 器(baidueditor)</li>
				<li><input type="radio" <?php echo in_array($r['form'],array('title','style','thumb','keywords','description','posid','content','status','point','amount'))?' disabled="disabled"':'';?> class="radio" name="info[form]" <?php echo $r['form']=='simpleueditor'?' checked="checked"':'';?> value="simpleueditor" />简单编辑器</li>
...
<li><input type="radio" <?php echo in_array($r['form'],array('title','style','thumb','keywords','description','posid','content','status','point','amount'))?' disabled="disabled"':'';?> class="radio" name="info[form]" <?php echo $r['form']=='color'?' checked="checked"':'';?> value="more" />颜色块</li>
				<?php
		...
		<tr class="bg2"><td></td><td><input type="button" class="button" onclick="doSubmit(this);" value="编辑字段" /> <input type="button" class="button" onclick="window.location.href='?file=model&action=fields&id=<?php echo $modelid;?>'" value="取消返回" /></td></tr>
	</table>
	</form>
