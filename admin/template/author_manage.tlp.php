...
<div id="wrap">
	<div class="tab">
		<ul>
			<li><a href="javascript:void(0);" class="on"><?php echo $lang['AUTHOR-LANG-1'];?></a></li>
			<li><a href="?file=author&action=add"><?php echo $lang['AUTHOR-LANG-2'];?></a></li>			
		</ul>
	</div>
	<div class="main">
		<fieldset>
		...
		<tr>
			...
			<td width="60" align="center"><a href="<?php echo ADMIN_FILE;?>?file=author&action=delete&id=<?php echo $val['id'];?>"><u>删除</u></a></td>
		</tr>
		<?php }?>
		<tr>
		...
		<?php }else{?>
		<tr><td colspan="5">目前尚未添加任何作者...</td></tr>	
		<?php }?>
		<tr>
			<td colspan="5"><?php echo $author->pagestring;?></td>
		</tr>
		</table>
	</div>
</div>
