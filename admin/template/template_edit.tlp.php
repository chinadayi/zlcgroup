...
<head>
<title><?php echo $lang['LEFT-TEMPLATE-8'];?></title>
...
<div id="wrap">
	<div class="tab">
		<ul>
			...
			<li><a href="?file=template&action=manage&project=<?php echo $project;?>&class=<?php echo $class;?>&page=<?php echo $page;?>"><?php echo $lang['LEFT-TEMPLATE-2'];?></a></li>
			<li><a href="javascript:void(0);" class="on"><?php echo $lang['LEFT-TEMPLATE-8'];?></a></li>			
		</ul>
	</div>
	<div class="main">
	<fieldset>
	...
	<input type="hidden" name="info[class]" value="<?php echo $class;?>">
	<input type="hidden" name="info[project]" value="<?php echo $project;?>">
	<input type="hidden" name="info[bak]" value="<?php echo $templateinfo['content'];?>">
	<table cellspacing="0" class="sub">
		<tr>
			<td width="8%" align="left" style="padding-left:10px">模板名称：</td>
			<td width="92%">
			<input type="text" name="info[name]" value="<?php echo $templateinfo['name'];?>" datatype="limit" min="2" max="100" size="20" />
		  </td>
		</tr>
		<tr>
			<td colspan="2">
			...
			<textarea name='info[content]' id="content" style="width:96%;height:450px; margin:8px; font-family:'宋体'"><?php echo $templateinfo['content'];?></textarea>
			</td>
		</tr>
		<tr class="bg2"><td colspan="2" align="center"><input type="button" class="button" onclick="doSubmit(this);" value="保存模板" /> <input type="button" class="button" onclick="window.location.href='?file=template&action=manage&project=<?php echo $project;?>&class=<?php echo $class;?>'" value="取消返回" /></td></tr>
	</table>
	</form>
